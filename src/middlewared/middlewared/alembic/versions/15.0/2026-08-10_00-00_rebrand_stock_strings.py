"""Rebrand the 13.3 stock strings that survive an in-place upgrade (freecore/the internal development record)
...
def upgrade():
    ...
    # already says FreeCORE is left alone. Site-specific MOTD and user values
