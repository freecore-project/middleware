...
Three concerns kept deliberately separate, per the epic:
  ...
  2. Execution — a C-level fork()+execve() (`subprocess.Popen`, i.e.
     ...
     *Python* in a forked child of this multi-threaded daemon; that window
     ...
     freecore/the internal development record / freecore/the internal development record (the codeberg
...
def _spawn(command):
    ...
    # freecore/the internal development record and freecore/the internal development record.
