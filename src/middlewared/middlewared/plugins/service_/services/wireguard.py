...
class WireguardService(SimpleService):
    ...
    # returns on FreeBSD 15 because wg-quick(8) does not exit (the internal development record),
    ...
    async def _get_state_freebsd(self):
        ...
        #
        # The private-key gate below is kept from the internal development record. It is no
