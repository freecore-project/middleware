# the internal development record: TrueCommand Cloud support is removed from FreeCORE.
...
class TrueCommandModel(sa.Model):
    ...
    # wg0.conf template read it too until the internal development record removed it.
