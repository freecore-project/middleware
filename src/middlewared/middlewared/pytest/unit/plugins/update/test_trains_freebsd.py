...
def test__check_train__cross_train_upgrade_ignores_older_build_time(monkeypatch):
    ...
    The regression this pins (freecore/the internal development record follow-up): FreeCORE-15.0-U1.4
...
def test__check_train__same_train_stale_build_time_is_still_unavailable(monkeypatch):
    """freecore/the internal development record must keep working when trains ARE named.
